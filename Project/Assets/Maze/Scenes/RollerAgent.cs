...
public class AgentCode : Agent
{
    ...
    public float prevDistanceToTarget = 100;
    public float step_punishment = -0.001f;
    public int steps;
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        // Failed to reach target after 10000 steps
        else if (steps > 10000)
        {
            this.transform.localPosition = new Vector3(0, 2f, 0);
            EndEpisode();
        ...
        // Penalize/award for distance
        AddReward(prevDistanceToTarget - distanceToTarget);
